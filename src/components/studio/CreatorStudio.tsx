...
export function CreatorStudio() {
  ...
  const { uploads, showToast } = useApp();
  ...
  const filmDefs = [
    { img: 1, title: "The Weight of Water", meta: "Drama · 1h 38m", status: "Live", vis: "Public · Free", ok: "live" as const, views: "41.9k", rev: "₦148,200", comp: 68, score: "9.4" },
    { img: 4, title: "Second Rain", meta: "Drama · 1h 36m", status: "Live", vis: "Public · Premium", ok: "live" as const, views: "6.3k", rev: "₦52,300", comp: 55, score: "8.1" },
    ...uploads.map((u) => ({ img: null, title: u.title, meta: "Awaiting review", status: "In Review", vis: "Hidden", ok: "review" as const, views: "—", rev: "—", comp: 0, score: "—" })),
    { img: null, title: "Untitled — Lagos Doc", meta: "Documentary · 52m", status: "In Review", vis: "Hidden", ok: "review" as const, views: "—", rev: "—", comp: 0, score: "—" },
  ];
                  ...
                  {filmRows.map((f, i) => (
                    <div key={i} style={{ display: "grid", gridTemplateColumns: "2.4fr 1fr 1fr 1fr 1.1fr 1fr 0.8fr", padding: "14px 20px", alignItems: "center", borderBottom: "1px solid var(--border-subtle)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                        <span style={{ width: 46, height: 62, flex: "none", borderRadius: 6, background: f.img ? bg(f.img, "40%") : "var(--surface-3)" }} />
